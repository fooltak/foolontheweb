...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                source: ['media/stop.mp3','media/stop.ogg']
            },
            {
                id: 'mo162',
                type: 'image',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid50", trigger: [ function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_stop}', [] ], ""], position: 27000 },
                ...
                { id: "eid79", trigger: [ function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_stop}', [0] ], ""], position: 45500 },
