...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'button-go',
                type: 'image',
                rect: ['206px', '45px','30px','30px','auto', 'auto'],
                cursor: ['pointer'],
            ...
            },
            {
                id: 'button-stop',
                type: 'image',
                rect: ['170px', '45px','30px','30px','auto', 'auto'],
                cursor: ['pointer'],
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid72", tween: [ "style", "${_signal-to-right}", "display", 'block', { fromValue: 'none'}], position: 35000, duration: 0, easing: "easeInQuad" },
                { id: "eid73", tween: [ "style", "${_signal-to-right}", "display", 'none', { fromValue: 'block'}], position: 43000, duration: 0, easing: "easeInQuad" },
                { id: "eid18", tween: [ "style", "${_mo162}", "left", '2000px', { fromValue: '-89px'}], position: 5912, duration: 9000, easing: "easeInQuad" },
                { id: "eid66", tween: [ "style", "${_mo162}", "left", '-89px', { fromValue: '2000px'}], position: 44000, duration: 9000, easing: "easeOutQuad" },
                ...
                { id: "eid75", tween: [ "style", "${_signal-to-left}", "display", 'block', { fromValue: 'none'}], position: 45000, duration: 0, easing: "easeInQuad" },
                { id: "eid77", tween: [ "style", "${_signal-to-left}", "display", 'none', { fromValue: 'block'}], position: 53000, duration: 0, easing: "easeInQuad" },
                ...
                { id: "eid60", tween: [ "transform", "${_bar2}", "rotateZ", '-90deg', { fromValue: '0deg'}], position: 37000, duration: 1000, easing: "easeInQuad" },
                { id: "eid61", tween: [ "transform", "${_bar2}", "rotateZ", '0deg', { fromValue: '-90deg'}], position: 43000, duration: 1000, easing: "easeInQuad" },
                { id: "eid69", tween: [ "transform", "${_bar2}", "rotateZ", '-90deg', { fromValue: '0deg'}], position: 47000, duration: 1000, easing: "easeInQuad" },
                { id: "eid68", tween: [ "transform", "${_bar2}", "rotateZ", '0deg', { fromValue: '-90deg'}], position: 53000, duration: 1000, easing: "easeInQuad" },
                { id: "eid47", tween: [ "style", "${_mo161}", "left", '-89px', { fromValue: '-2178px'}], position: 25000, duration: 9000, easing: "easeOutQuad" },
                { id: "eid52", tween: [ "style", "${_mo161}", "left", '2000px', { fromValue: '-89px'}], position: 40000, duration: 9000, easing: "easeInQuad" },
                ...
                { id: "eid70", tween: [ "style", "${_signal-light}", "display", 'block', { fromValue: 'none'}], position: 35000, duration: 0, easing: "easeInQuad" },
                { id: "eid71", tween: [ "style", "${_signal-light}", "display", 'none', { fromValue: 'block'}], position: 43000, duration: 0, easing: "easeInQuad" },
                { id: "eid74", tween: [ "style", "${_signal-light}", "display", 'block', { fromValue: 'none'}], position: 45000, duration: 0, easing: "easeInQuad" },
                { id: "eid76", tween: [ "style", "${_signal-light}", "display", 'none', { fromValue: 'block'}], position: 53000, duration: 0, easing: "easeInQuad" },
                ...
                { id: "eid78", trigger: [ function executeSymbolFunction(e, data) { this._executeSymbolAction(e, data); }, ['play', '${_signal-light}', [] ], ""], position: 35000 },
                { id: "eid80", trigger: [ function executeSymbolFunction(e, data) { this._executeSymbolAction(e, data); }, ['stop', '${_signal-light}', [] ], ""], position: 43000 },
                { id: "eid82", trigger: [ function executeSymbolFunction(e, data) { this._executeSymbolAction(e, data); }, ['play', '${_signal-light}', [] ], ""], position: 45000 },
                { id: "eid84", trigger: [ function executeSymbolFunction(e, data) { this._executeSymbolAction(e, data); }, ['stop', '${_signal-light}', [] ], ""], position: 53000 }            ]
        }
    }
},
"signal-light": {
